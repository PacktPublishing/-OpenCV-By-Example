...
int main(int argc, char** argv)
{
    ...
    namedWindow("Output image after opening", CV_WINDOW_AUTOSIZE);
    namedWindow("Output image after closing", CV_WINDOW_AUTOSIZE);
    namedWindow("Output image after morphological gradient", CV_WINDOW_AUTOSIZE);
    namedWindow("Output image after top hat", CV_WINDOW_AUTOSIZE);
    namedWindow("Output image after black hat", CV_WINDOW_AUTOSIZE);
